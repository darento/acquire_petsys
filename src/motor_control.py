...
class MotorControl:
    ...
    def __init__(self, serial_port :str, 
        ...
        self.configure_motor(motor_relation, motor_microstep, motor_start, motor_end, motor_step_size)
    ...
    def configure_motor(self, motor_relation, motor_microstep, motor_start, motor_end, motor_step_size):
    ...
    def move_to_position(self, position_mm: float):
